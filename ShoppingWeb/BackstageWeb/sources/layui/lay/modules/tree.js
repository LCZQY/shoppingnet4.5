        ...
        g.prototype.config = {
                    ...
                    a.drag && e.drag(),
                        ...
                        e.elem.find(".layui-tree-set").each(function () {
                            ...
                            e.parent(".layui-tree-pack")[0] || e.addClass("layui-tree-setHide"),
                                !e.next()[0] && e.parents(".layui-tree-pack").eq(1).hasClass("layui-tree-lineExtend") && e.addClass(C),
                                e.next()[0] || e.parents(".layui-tree-set").eq(0).next()[0] || e.addClass(C)
                        }),
                        e.events()
                }
            },
                ...
                layui.each(l,
                    function (a, l) {
                        var c = l.children && l.children.length > 0,
                            ...
                            h = i(['<div data-id="' + l.id + '" class="layui-tree-set' + (l.spread ? " layui-tree-spread" : "") + (l.checked ? " layui-tree-checkedFirst" : "") + '">', "<div " + (r.drag && !l.fixed ? 'draggable="true"' : "") + ' class="layui-tree-entry">', '<div class="layui-tree-main">',
                            function () {
                            ...
                            function () {
                                ...
                                return r.edit === !0 && (r.edit = ["update", "del"]),
                                    "object" == typeof r.edit ? (layui.each(r.edit,
                                        function (a, n) {
                                            i.push(e[n] || "")
                                        }), i.join("") + "</div>") : void 0
                            }(), "</div></div>"].join(""));
                        c && (h.append(o), n.tree(o, l.children)),
                            e.append(h),
                            h.prev("." + s)[0] && h.prev().children(".layui-tree-pack").addClass("layui-tree-showLine"),
                            c || h.parent(".layui-tree-pack").addClass("layui-tree-lineExtend"),
                            n.spread(h, l),
                            r.showCheckbox && n.checkClick(h, l),
                            r.edit && n.operate(h, l)
                    })
            },
            g.prototype.spread = function (e, a) {
                ...
                k.on("click",
                    function (i) {
                        ...
                        if (a[0]) {
                            if (e.hasClass(v)) e.removeClass(v),
                                a.slideUp(200),
                                n.removeClass(h).addClass(o);
                            else if (e.addClass(v), a.slideDown(200), n.addClass(h).removeClass(o), r.accordion) {
                                var l = e.siblings("." + s);
                                l.removeClass(v),
                                    l.children("." + y).slideUp(200),
                                    l.find(".layui-tree-icon").children(".layui-icon").removeClass(h).addClass(o)
                            }
                        } else g = "normal"
                    }),
                    m.on("click",
            ...
            g.prototype.checkClick = function (e, a) {
                var n = this,
                    ...
                    l = e.children("." + u),
                    t = l.children("." + f);
                t.on("click", 'input[name="layuiTreeCheck"]+',
                    function (l) {
                        layui.stope(l);
                        var t = i(this).prev(),
                            d = t.prop("checked");
                    ...
                    function (l) {
                        ...
                        if ("add" == f) {
                            ...
                            var b = r.operate && r.operate(x),
                                w = {};
                            if (w.title = r.text.defaultNodeName, w.id = b, n.tree(e.children("." + y), [w]), r.showLine) if (g[0]) g.hasClass(k) || g.addClass(k),
                                e.find("." + y).each(function () {
                                    i(this).children("." + s).last().addClass(C)
                                }),
                                g.children("." + s).last().prev().hasClass(C) ? g.children("." + s).last().prev().removeClass(C) : g.children("." + s).last().removeClass(C),
                                !e.parent("." + y)[0] && e.next()[0] && g.children("." + s).last().removeClass(C);
                            else {
                                var T = e.siblings("." + s),
                                    L = 1,
                                    N = e.parent("." + y);
                            ...
                            d.children("." + p).html(""),
                                ...
                                d.children(".layui-tree-editInput").val(q).focus();
                            var F = function (e) {
                                var i = e.val().trim();
                        ...
                        function (n) {
                            ...
                            var S = function (n) {
                                ...
                                if (1 == H) a.showLine ? (n.find("." + c).removeClass("layui-tree-icon"), n.find("." + c).children(".layui-icon").removeClass(h).addClass("layui-icon-file"), q.addClass(k), q.children("." + s).children("." + y).each(function () {
                                    i(this).children("." + s).last().addClass(C)
                                })) : n.find(".layui-tree-iconArrow").addClass(t),
                                    n.children("." + y).remove(),
                                    n.removeClass(v);
                                else {
                                    if (a.showLine) {
                            ...
                            g.each(function () {
                                if (0 != i(this).height()) {
                                    ...
                                    if (r > n && r < n + 15) {
                                        ...
                                        return a.dragend && a.dragend("drag success", d, i(this)),
                                            !1
                                    }
                                    if (r < n) {
                                        if (i(this).before(d), S(A), a.showLine) {
                                            ...
                                            if (b[0]) {
                                                d.removeClass(C),
                                                    b.children("." + s).last().removeClass(C);
                                                var h = d.siblings("." + s),
                                                    v = 1;
                                                layui.each(h,
                                                    function (e, a) {
                                                    ...
                                                    1 == v ? T[0] && (h.children("." + y).addClass(m), h.children("." + y).children("." + s).removeClass(C), L.children("." + y).children("." + s).last().addClass(C).removeClass(m)) : d.children("." + y).children("." + s).last().addClass(C),
                                                    !T.parent("." + y)[0] && T.next()[0] && L.removeClass(C)
                                            } else T.hasClass(k) || T.addClass(k),
                                                T.find("." + y).each(function () {
                                                    i(this).children("." + s).last().addClass(C)
                                                });
                                        ...
                                        return a.dragend && a.dragend("拖拽成功，插入目标节点上方", d, i(this)),
                                            !1
                                    }
                                    if (r > w) return e.elem.children("." + s).last().children("." + y).addClass(m),
                                        e.elem.append(d),
                                        S(A),
                                        d.prev().children("." + y).children("." + s).last().removeClass(C),
                                        d.addClass("layui-tree-setHide"),
                                        d.children("." + y).children("." + s).last().addClass(C),
                                        a.dragend && a.dragend("拖拽成功，插入最外层节点", d, e.elem),
                                        !1
                                }
                            })
                        })
                    ...
                    e.elem.find(".layui-tree-search").on("keyup",
                        function () {
                            ...
                            l.find("." + p).each(function () {
                                ...
                                if (i(this).html().indexOf(r) != -1) {
                                    ...
                                    var a = function (e) {
                                        e.addClass("layui-tree-searchShow"),
                                            e.parent("." + y)[0] && a(e.parent("." + y).parent("." + s))
                                    };
                                    a(e.parent("." + s))
                                }
                            }),
                                ...
                                0 == l.find(".layui-tree-searchShow").length && e.elem.append(e.elemNone),
                                ...
                                function (e, n) {
                                    if (r.id == n) {
                                        ...
                                        return delete t.children,
                                            a.push(t),
                                            r.children && (t.children = [], l(r.children, t.children)),
                                            !0
                                    }
                                })
                        })
            ...
            g.prototype.setChecked = function (e) {
                ...
                a.elem.find("." + s).each(function (a, n) {
                    var r = i(this).data("id"),
                        ...
                        t = l.next();
                    if ("number" == typeof e) {
                        if (r == e) return l[0].checked || t.click(),
                            !1
